...
Installing nema_analysis_tool will add several new commands to your terminal. These commands are used to run the entire analysis. You can execute them from any location on your system. All nema_analysis_tool commands have the prefix `nema_quant` for easy identification.
